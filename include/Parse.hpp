...
namespace nts {
    ...
    public:
        ...
        static void parse_link(std::vector<std::string> tab, std::map<std::string, IComponent *> component, std::map<std::string, IComponent *> output, std::map<std::string, IComponent *> input);
